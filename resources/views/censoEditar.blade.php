...
<div class="container">
           ...
           <h4 class="alert alert-info text-center">Consejo comunal Unidad San Juan ubicado en la Parroquia San Juan av.San Martin <br>Municipio libertador - Caracas </h4> 
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{route('censoEditarGuardar')}}" method="POST" class="form-horizontal" id="formCenso">
                        {{ csrf_field() }}
                        <input type="hidden" name="id_persona" id="id_persona" value="{{$censo[0]->id_persona}}"/>
                        <input type="hidden" name="id_censo" id="id_censo" value="{{$censo[0]->numero_planilla}}"/>

                        <div class="form-group">
                            <label for="fecha" class="col-md-2 control-label">Fecha</label>
                            <div class="col-md-4">
                                <input id="fecha" type="date" class="form-control" name="fecha" value="{{$censo[0]->fecha}}">
                            </div>
                            <label for="numero_planilla" class="col-md-2 control-label">Número de planilla</label>
                            <div class="col-md-4">
                                <input id="numero_planilla" type="text" class="form-control" name="numero_planilla" value="{{$censo[0]->numero_planilla}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 m-0 p-0" data-name="censo" data-page="1">
                            ...
                            <div class="form-group">
                                <label for="cedula" class="col-md-2 col-md-offset-6 control-label">Cédula</label>
                                <div class="col-md-1">
                                    <select name="nacionalidad" id="nacionalidad" class="form-control" readonly>
                                        <option value="">-</option>
                                        @if ($censo[0]->nacionalidad == 1)
                                ...
                                <div class="col-md-3">
                                    <input id="cedula" type="text" class="form-control" name="cedula" readonly value="{{$censo[0]->cedula}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="nombre" type="text" class="form-control" name="nombre" value="{{$censo[0]->nombre}}" required>
                                </div>
                                <label for="apellido" class="col-md-2 control-label">Apellido</label>
                                <div class="col-md-4">
                                    <input id="apellido" type="text" class="form-control" name="apellido" value="{{$censo[0]->apellido}}" required>
                                </div>
                            </div>
 <div class="form-group col-md-6">
  ...
  <div class="col-md-12 text-center"><br><br>
                                <button class="btn btn-primary btn-lg" data-name="atras" data-to="5" action="{{route('censoListar')}}">Atras</button>
