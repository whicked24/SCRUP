                ...
                <div class="panel-body">
                    <form action="#" method="POST" class="form-horizontal" id="formCenso" name="formCenso">
                        ...
                        <div class="col-md-12 m-0 p-0 hidden" data-name="censo" data-page="2">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-lg" data-name="atras" data-to="1">Anterior</button>
                        ...
                        <div class="col-md-12 m-0 p-0 hidden" data-name="censo" data-page="3">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-lg" data-name="atras" data-to="2">Anterior</button>
                        ...
                        <div class="col-md-12 m-0 p-0 hidden" data-name="censo" data-page="4">
                           ...
                           <div class="col-md-12 m-0 p-0">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-lg" data-name="atras" data-to="3">Anterior</button>
                        ...
                        <div class="col-md-12 m-0 p-0 hidden" data-name="censo" data-page="5">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-lg" data-name="atras" data-to="4">Anterior</button>
                        ...
                        <div class="col-md-12 m-0 p-0 hidden" data-name="censo" data-page="6">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-lg" data-name="atras" data-to="5">Anterior</button>
