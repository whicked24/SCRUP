$(document).ready(function(){
    ...
    $("#fecha_nacimiento").on('blur', function(e){
        ...
        if (edad < 18){
          alert('El jefe de familia no puede tener menos de 18 años');
          $(this).val('');
          $('#edad').val(0);
        }else{
          $('#edad').val(edad);
...
//COMIENZO DE LA VALIDACION SUBMIT
   ...
   var enfermedades = [];
        ...
        if ($('#formCenso').smkValidate()) {
          ...
          console.log(enfermedadesFamiliares);
          console.log(discapacidadesFamiliares);
