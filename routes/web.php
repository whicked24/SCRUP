...
/*
Route::get('/jornadas/', 'JornadasController@listar')->name('jornadasListar');

Route::get('/jornadas/nuevo', 'JornadasController@nuevo')->name('jornadasNuevo');

Route::post('/jornadas/todos', 'JornadasController@todos')->name('jornadasTodos');
*/
